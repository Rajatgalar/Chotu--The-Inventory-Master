...
class ConsigneeUseCase @Inject constructor(
    private val buyerRepository: ConsigneeRepository
) {
    fun sendData(buyer: ConsigneeModel, isForUpdate : Boolean, documentId : String) : Resource<Unit>{
        return try{
