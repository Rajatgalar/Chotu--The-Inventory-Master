package com.itechnowizard.chotu.presentation.proforma.addproforma
...
import com.itechnowizard.chotu.presentation.proforma.ProformaInvoiceViewModel
...
@AndroidEntryPoint
class AddProformaInvoice : AppCompatActivity() {
    private lateinit var binding: ActivityAddPerformaInvoiceBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddPerformaInvoiceBinding.inflate(layoutInflater)
        ...
        binding.apply {
            ...
            btnTransportDetails.setOnClickListener {openActivityWithData(transportModel,
            ...
            ivEditTransport.setOnClickListener { openActivityWithData(transportModel,
                TransportDetails::class.java) }
            ...
            etInvoiceDate.setOnClickListener {
                DateUtils.showDatePicker(this@AddProformaInvoice) { selectedDate ->
    ...
    private fun setDataForAdd() {
        ...
        ToolbarUtils.setToolbar(
            ...
            true,
            Constants.TOOLBAR_CREATE_PROFORMA,
