...
class PdfPaymentMade {
    ...
    fun createUserTable(
        ...
        val para = Paragraph("PAYMENT MADE", TITLE_FONT)
        ...
        val headerTable = addSeller(receipt.receiptNumber!!,receipt.paymentDate!!
            , receipt.sellerName!!,receipt.paymentMode!!
    ...
    private fun addSeller(
        ...
        table.addCell(PdfHelper.createBorderLessCell("Paid To",Element.ALIGN_LEFT))
